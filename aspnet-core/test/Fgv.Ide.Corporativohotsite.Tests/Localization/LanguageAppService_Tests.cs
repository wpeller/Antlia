...
namespace Fgv.Ide.Corporativohotsite.Tests.Localization
{
...
#pragma warning restore 162
        ...
        [MultiTenantFact] //Abp Issue: https://github.com/aspnetzero/aspnet-zero-core/issues/1998
        ...
        public async Task UpdateLanguageText()
        {
            await _languageAppService.UpdateLanguageText(
                ...
                {
                    SourceName = CorporativohotsiteConsts.LocalizationSourceName,
                    LanguageName = "en",
                    Key = "Save",
