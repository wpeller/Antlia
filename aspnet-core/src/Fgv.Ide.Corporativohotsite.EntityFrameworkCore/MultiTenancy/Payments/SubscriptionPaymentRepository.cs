...
{
    public class SubscriptionPaymentRepository : CorporativohotsiteRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<CorporativohotsiteDbContext> dbContextProvider)
