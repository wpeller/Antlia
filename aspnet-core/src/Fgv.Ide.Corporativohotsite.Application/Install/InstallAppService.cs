...
namespace Fgv.Ide.Corporativohotsite.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : CorporativohotsiteAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<CorporativohotsiteDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(CorporativohotsiteConsts.ConnectionStringName).Value.ToString();
        }
