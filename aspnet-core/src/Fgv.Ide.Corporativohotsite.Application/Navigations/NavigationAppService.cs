...
{
    public class NavigationAppService : CorporativohotsiteAppServiceBase, INavigationAppService
    {
        ...
        public async Task<NavigationDto> SendAndSynchronize(NavigationDto model)
        {
            ...
            foreach (var nav in navigations)
            {
                ...
                var p = new NavigationDto
                {
                    ...
                    Visible = true,
                    External = application != null && application.Name != CorporativohotsiteConsts.ModuleName,
