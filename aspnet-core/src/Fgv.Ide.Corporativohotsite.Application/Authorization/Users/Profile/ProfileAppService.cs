...
using Fgv.Ide.Corporativohotsite.Authorization.Users.Profile.Cache;
using Fgv.Ide.Corporativohotsite.Authorization.Users.Profile.Dto;
using Fgv.Ide.Corporativohotsite.Gdpr;
...
using Fgv.Ide.Corporativohotsite.Timing;

namespace Fgv.Ide.Corporativohotsite.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : CorporativohotsiteAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Fgv.Ide.Corporativohotsite",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Fgv.Ide.Corporativohotsite",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
