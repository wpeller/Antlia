...
using Fgv.Ide.Corporativohotsite.Authorization.Permissions;
...
using Fgv.Ide.Corporativohotsite.Authorization.Users.Exporting;
...
namespace Fgv.Ide.Corporativohotsite.Authorization.Users
{
    ...
    public class UserAppService : CorporativohotsiteAppServiceBase, IUserAppService
    {
