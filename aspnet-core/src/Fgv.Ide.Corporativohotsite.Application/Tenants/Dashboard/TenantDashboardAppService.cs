...
using Fgv.Ide.Corporativohotsite.Tenants.Dashboard.Dto;

namespace Fgv.Ide.Corporativohotsite.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : CorporativohotsiteAppServiceBase, ITenantDashboardAppService
    {
