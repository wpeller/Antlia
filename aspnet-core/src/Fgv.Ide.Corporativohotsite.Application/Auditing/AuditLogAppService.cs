...
using Fgv.Ide.Corporativohotsite.Auditing.Exporting;
...
using EntityHistoryHelper = Fgv.Ide.Corporativohotsite.EntityHistory.EntityHistoryHelper;

namespace Fgv.Ide.Corporativohotsite.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : CorporativohotsiteAppServiceBase, IAuditLogAppService
    {
