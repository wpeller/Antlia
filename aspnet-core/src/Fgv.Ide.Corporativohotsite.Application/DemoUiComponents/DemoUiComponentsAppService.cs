...
using Fgv.Ide.Corporativohotsite.DemoUiComponents.Dto;

namespace Fgv.Ide.Corporativohotsite.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : CorporativohotsiteAppServiceBase, IDemoUiComponentsAppService
    {
