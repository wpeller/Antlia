...
namespace Fgv.Ide.Corporativohotsite.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : CorporativohotsiteServiceBase, ITransientDependency
    {
