...
{
    public class SessionAppService : CorporativohotsiteAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            ...
            if (AbpSession.UserId.HasValue)
            {
				...
				output.User.Siga2UserName = _principalAccessor.Principal?.Claims.FirstOrDefault(x => x.Type == CorporativohotsiteConsts.ClaimSiga2UserName)?.Value;
				output.User.Siga2Name = _principalAccessor.Principal?.Claims.FirstOrDefault(x => x.Type == CorporativohotsiteConsts.ClaimSiga2Name)?.Value;
            }
