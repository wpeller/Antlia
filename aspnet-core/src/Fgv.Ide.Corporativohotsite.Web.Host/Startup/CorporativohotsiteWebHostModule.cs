...
using Fgv.Ide.Corporativohotsite.Web.Url;
using Newtonsoft.Json.Linq;

namespace Fgv.Ide.Corporativohotsite.Web.Startup
{
    [DependsOn(
        typeof(CorporativohotsiteWebCoreModule)
    )]
    public class CorporativohotsiteWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public CorporativohotsiteWebHostModule(
        ...
        public override void PreInitialize()
        {
            ...
            IocManager.RegisterIfNot<IWebUrlService, WebUrlService>();
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(CorporativohotsiteWebHostModule).GetAssembly());
        }
