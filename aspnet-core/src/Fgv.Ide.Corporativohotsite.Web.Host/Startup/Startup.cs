...
using Fgv.Ide.Corporativohotsite.Web.IdentityServer;
using Fgv.Ide.Corporativohotsite.Web.Swagger;
using Hangfire;
...
namespace Fgv.Ide.Corporativohotsite.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.SwaggerDoc("v1", new Info { Title = "Corporativohotsite API", Version = "v1" });
            ...
            return services.AddAbp<CorporativohotsiteWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Corporativohotsite API V1");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("Fgv.Ide.Corporativohotsite.Web.wwwroot.swagger.ui.index.html");
