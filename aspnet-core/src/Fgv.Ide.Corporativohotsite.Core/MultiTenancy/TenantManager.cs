...
using Fgv.Ide.Corporativohotsite.MultiTenancy.Demo;
...
namespace Fgv.Ide.Corporativohotsite.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(CorporativohotsiteConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
