namespace Fgv.Ide.Corporativohotsite.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_Administration_Swagger = "Pages.Administration.Swagger";
        ...
        public const string API = "APIs";

        public const string APIS2_Usuario = "API.Siga2.Usuario";
        public const string APIS2_Usuario_TrocarSenha = "API.Siga2.Usuario.TrocarSenha"; // Somente Identity Manager
    }
}