    ...
    public class Navigation : Entity<Guid>
    {
        ...
        public virtual string LocalizableDisplayName
        {
            ...
            set
            {
                ...
                DisplayNameEnUs = LocalizationHelper.GetString(CorporativohotsiteConsts.LocalizationSourceName, _localizableDisplayName, new CultureInfo("en-US"));
                DisplayNamePtBr = LocalizationHelper.GetString(CorporativohotsiteConsts.LocalizationSourceName, _localizableDisplayName, new CultureInfo("pt-BR"));
            }
        }
