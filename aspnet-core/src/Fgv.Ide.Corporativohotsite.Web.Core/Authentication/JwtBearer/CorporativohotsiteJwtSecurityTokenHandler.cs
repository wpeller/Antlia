...
namespace Fgv.Ide.Corporativohotsite.Web.Authentication.JwtBearer
{
    public class CorporativohotsiteJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public CorporativohotsiteJwtSecurityTokenHandler()
        {
