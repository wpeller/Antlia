...
namespace Fgv.Ide.Corporativohotsite.Web.Security.Recaptcha
{
    public class RecaptchaValidator : CorporativohotsiteServiceBase, IRecaptchaValidator, ITransientDependency
    {
