...
import { API_BASE_URL, MovimentoServicoServiceProxy, ProdutoCosifServiceProxy, ProdutoServiceProxy, UiCustomizationSettingsDto } from '@shared/service-proxies/service-proxies';
...
function initializeLocalForage() {
    localForage.config({
        ...
        name: 'Corporativohotsite',
        version: 1.0,
        storeName: 'abpzerotemplate_local_storage',
        description: 'Cached data for Corporativohotsite'
    });
}
...
@NgModule({
    ...
    providers: [
        ...
        MovimentoServicoServiceProxy,
        ProdutoServiceProxy,
        ProdutoCosifServiceProxy,
    ],
